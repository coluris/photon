...
namespace boost
{
  namespace asio
  {
    ...
    std::size_t write(SyncWriteStream &s,
                      ...
                      CompletionCondition completion_condition, boost::system::error_code &ec,
                      typename constraint<
                          is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value>::type,
                      typename constraint<
                          !is_dynamic_buffer_v2<typename decay<DynamicBuffer_v1>::type>::value>::type)
    {
    ...
    std::size_t write(SyncWriteStream &s, DynamicBuffer_v2 buffers,
                      CompletionCondition completion_condition, boost::system::error_code &ec,
                      typename constraint<
                          is_dynamic_buffer_v2<DynamicBuffer_v2>::value>::type)
    {
      ...
      public:
                        ...
                        std::size_t bytes_transferred, int start = 0)
        {
          ...
          case 1:
            ...
            BOOST_ASIO_MOVE_OR_LVALUE(WriteHandler)
            (handler_)(
